...
//rotornar o usuário atualmente logado
...
const update = async(req, res) => {
    // res.send('Atualização de Usuárrio.');
    ...
    //se foi enviado um novo nome, precedemos com a atualização dele
    if(name) {
        user.name = name;
    }

    //se foi enviada uma nova senha, procedemos com a sua atualização
    if(password) {
    ...
    //se foi enviada imagem de perfil, precedemos com sua atualização
    if(profileImage) {
        user.profileImage = profileImage;
    }

    //se foi enviada descrção do usuáiro, procedemos com sua atualização
    if(bio) {
        user.bio = bio;
    }
