  ...
  return (
    <BrowserRouter>
      ...
      <div className='container'>
        <Routes>
          {/*só pode acessar a Home se estriver autenticado, senão vai para o Login */}
          <Route 
            path="/"
            element={auth ? <Home /> : <Navigate to="/login" />}
          />
          {/*só pode acessar o Login se não estiver autenticado, senão vai para Home */}
          <Route 
            path="/login"
            element={!auth ? <Login /> : <Navigate to="/" />}
          />
          {/*só pode acessar o Register se não estiver autenticadom senão vai para Home */}
          <Route
            path="/register"
