...
export const profile = createAsyncThunk (
    "user/profile",
    async (user, thunkAPI) => {
        //pegamos o token salvo em authSlice.jsx para utiliza-ló aqui
        const token = thunkAPI.getState().auth.user.toekn;
...
export const updateProfile = createAsyncThunk(
    ...
    async (user, thunkAPI) => {
        ...
        const data = await userSlice.updateProfile(user, token);
...
//Recuperar os dados de uusuário por id
...
export const userSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        //o builder irá 'construir' para gente os diversos 'casos' possíveis para cada requisição
        builder
