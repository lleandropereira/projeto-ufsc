...
const EditProfile = () => {
    ...
    useEffect(() => {
        dispatch(profile());
    }, [dispatch]); //será executao sempre que houver um dispatch deste componente
    ...
    const onSubmit = async (data) => {
        //vam,os construir um objeto form-data que será passado pela requisição
  ...
  return (
    <div id="edit-profile">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <input {...register("email")} type="email" placeholder="E-mail" disabled/>
            <label>
            ...
            <label>
                <span>Bio:</span>
                <input {...register("bio")} type="text" placeholder="Descrição do perfil" />
            </label>
            <label>
                <span>Deseja alterar sua senha?</span>
                <input {...register("password")} type="password" placeholder="Digite sua nova senha"/>
            </label>
