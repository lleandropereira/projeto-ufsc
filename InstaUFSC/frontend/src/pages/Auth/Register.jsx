...
const Register = () => {
  ...
  const dispath = useDispatch(); //o dispatch é quem nos possibilita chamarmos as funções Redux
  ...
  const handleSubmit = (e) => {
    ...
    dispath(register(user)); //chama a função de registro de usuário que irá acionar a API
  };
  ...
  useEffect(() => {
    dispath(reset());
  }, [dispath]); //o useEffect irá monitorar cada dispatch executado
  ...
  return (
    <div id="register">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input type="password" placeholder="Senha" name="password" onChange={handleChange} value={user.password}/>
        
        <input type="password" placeholder="Confirme a senha" name="confirmPassword" onChange={handleChange} value={user.confirmPassword}/>
